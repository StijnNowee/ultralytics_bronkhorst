...
from ultralytics_bronkhorst.hub.utils import HUB_WEB_ROOT, HELP_MSG, PREFIX, TQDM
from ultralytics_bronkhorst.utils import LOGGER, SETTINGS, __version__, checks, emojis, is_colab
from ultralytics_bronkhorst.utils.errors import HUBModelError
...
class HUBTrainingSession:
    ...
    Attributes:
        ...
        model (dict): Model data fetched from ultralytics_bronkhorst HUB.
    ...
    def load_model(self, model_id):
        """Loads an existing model from ultralytics_bronkhorst HUB using the provided model identifier."""
