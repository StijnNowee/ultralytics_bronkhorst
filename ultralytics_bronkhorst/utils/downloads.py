...
from ultralytics_bronkhorst.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Example:
        ```python
        from ultralytics_bronkhorst.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=(".DS_Store", "__MACOSX"), progress=True):
    ...
    Example:
        ```python
        from ultralytics_bronkhorst.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=(".DS_Store", "__MACOSX"), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from ultralytics_bronkhorst.utils.downloads import unzip_file
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from ultralytics_bronkhorst.utils.downloads import get_google_drive_file_info
...
def safe_download(
    ...
    Example:
        ```python
        from ultralytics_bronkhorst.utils.downloads import safe_download
...
def attempt_download_asset(file, repo="ultralytics/assets", release="v8.1.0", **kwargs):
    ...
    Example:
        ...
        ```
    """
    from ultralytics_bronkhorst.utils import SETTINGS  # scoped for circular import
