...
Usage:
    from ultralytics_bronkhorst.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics_bronkhorst import YOLO, YOLOWorld
from ultralytics_bronkhorst.cfg import TASK2DATA, TASK2METRIC
from ultralytics_bronkhorst.engine.exporter import export_formats
from ultralytics_bronkhorst.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics_bronkhorst.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from ultralytics_bronkhorst.utils.files import file_size
from ultralytics_bronkhorst.utils.torch_utils import select_device
...
class ProfileModels:
    ...
    Example:
        ```python
        from ultralytics_bronkhorst.utils.benchmarks import ProfileModels
