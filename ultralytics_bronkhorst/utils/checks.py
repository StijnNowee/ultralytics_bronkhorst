...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Example:
        ```python
        from ultralytics_bronkhorst.utils.checks import parse_requirements
...
def check_requirements(requirements=ROOT.parent / "requirements.txt", exclude=(), install=True, cmds=""):
    ...
    Example:
        ```python
        from ultralytics_bronkhorst.utils.checks import check_requirements
...
def collect_system_info():
    ...
    from ultralytics_bronkhorst.utils import ENVIRONMENT, is_git_dir
    from ultralytics_bronkhorst.utils.torch_utils import get_cpu_info
...
def check_amp(model):
    ...
    Example:
        ...
        from ultralytics_bronkhorst.utils.checks import check_amp
    ...
    def amp_allclose(m, im):
        ...
        print("fp32 inference done")
        with torch.cuda.amp.autocast(True):
            print("start amp inference")
            b = m(im, device=device, verbose=False)[0].boxes.data  # AMP inference
            print("amp inference done")
        del m
        print("m")
