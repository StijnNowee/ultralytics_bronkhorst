...
from ultralytics_bronkhorst.engine.predictor import BasePredictor
from ultralytics_bronkhorst.engine.results import Results
from ultralytics_bronkhorst.utils import ops
...
class RTDETRPredictor(BasePredictor):
    ...
    Example:
        ```python
        from ultralytics_bronkhorst.utils import ASSETS
        from ultralytics_bronkhorst.models.rtdetr import RTDETRPredictor
