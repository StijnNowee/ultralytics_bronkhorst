...
from ultralytics_bronkhorst.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics_bronkhorst.hub.utils import HUB_WEB_ROOT
from ultralytics_bronkhorst.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from ultralytics_bronkhorst.utils import ASSETS, DEFAULT_CFG_DICT, LOGGER, RANK, SETTINGS, callbacks, checks, emojis, yaml_load
...
class Model(nn.Module):
    ...
    Args:
        model (Union[str, Path], optional): Path or name of the model to load or create. This can be a local file
            path, a model name from ultralytics_bronkhorst HUB, or a Triton Server model. Defaults to 'yolov8n.pt'.
    ...
    def __init__(
        ...
        Args:
            model (Union[str, Path], optional): The path or model file to load or create. This can be a local
                file path, a model name from ultralytics_bronkhorst HUB, or a Triton Server model. Defaults to 'yolov8n.pt'.
    ...
    def _get_hub_session(model: str):
        ...
        from ultralytics_bronkhorst.hub.session import HUBTrainingSession
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_bronkhorst import __version__
    ...
    def track(
        ...
        **kwargs,
        ...
        if not hasattr(self.predictor, "trackers"):
            from ultralytics_bronkhorst.trackers import register_tracker
    ...
    def tune(
        ...
        **kwargs,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics_bronkhorst.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        """
        from ultralytics_bronkhorst.nn.autobackend import check_class_names
